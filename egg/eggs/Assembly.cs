...
namespace eggs {
    ...
    public static class Assembly {
        ...
        /// 获取程序参数集
        /// </summary>
        public static egg.Console.IParams Params { get; private set; }

        /// <summary>
        /// 设置参数集合
        /// </summary>
        /// <returns></returns>
        public static void SetParams<T>(string[] args) where T : egg.Console.IParams, new() {
            Params = GetParams<T>(args);
        }
        ...
        /// <returns></returns>
        public static T GetParams<T>(string[] args) where T : egg.Console.IParams, new() {
            var obj = new T();
            obj.SetParams(args);
            return obj;
        }
