...
namespace egg {
    ...
    /// 动态对象
    /// </summary>
    internal class EggDynamicMetaObject : System.Dynamic.DynamicMetaObject {
        ...
        public EggDynamicMetaObject(Expression expression, object value) : base(expression, BindingRestrictions.Empty, value) {
            //json = (Json)value;
        }
    ...
    public class Dynamic : KeyList<object>, IDynamicMetaObjectProvider {
        ...
        DynamicMetaObject IDynamicMetaObjectProvider.GetMetaObject(Expression parameter) {
            ...
            return new EggDynamicMetaObject(parameter, this);
        }
    }
}
