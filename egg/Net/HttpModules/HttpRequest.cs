...
namespace egg.Net.HttpModules {
    ...
    /// Http提交管理器
    /// </summary>
    public class HttpRequest : egg.BasicObject {

        /// <summary>
        /// 获取地址信息对象
        /// </summary>
        public egg.Net.Uri Uri { get; private set; }

        /// <summary>
        /// 头部信息
        /// </summary>
        public HttpHeaders Header { get; private set; }
        ...
        public HttpRequest(string url) {
            this.Uri = new egg.Net.Uri(url);
            this.Header = new HttpHeaders();
            Header["Host"] = Uri.Host + (Uri.Port > 0 ? ":" + Uri.Port : "");
