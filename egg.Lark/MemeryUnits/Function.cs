        ...
        private MemeryUnits.Unit ExecuteProcess() {
            switch (this.Name) {
                ...
                case "let": // 赋值操作
                    ...
                    if (eggs.Object.IsNull(this.ParentFunction)) throw new Exception("let函数未找到父函数");
                ...
                case "set": // 赋值数组操作
                    ...
                    if (eggs.Object.IsNull(this.ParentFunction)) throw new Exception("set函数未找到父函数");
                    // 定义操作对象
