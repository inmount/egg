...
namespace egg.Mvc {
    ...
    /// API控制呈现器处理上下文
    /// </summary>
    public class ApiControllerRenderContext : egg.BasicObject {
        ...
        public string Success(string msg = null) {
            ...
            if (!msg.IsEmpty()) this.Response.Message = msg;
        ...
        public string Success(db.Rows rows, string msg = null) {
            this.Response.Result = 1;
            if (!msg.IsEmpty()) this.Response.Message = msg;
            this.Response.Datas = rows.ToJsonList();
            return this.Response.ToJsonString();
        }
        ...
        public string Error(int code = 0, string msg = null, string info = null) {
            this.Response.Result = -1;
            if (!msg.IsEmpty()) this.Response.Message = msg;
            if (!info.IsEmpty()) this.Response.ErrorInfo = info;
